                ...
                <div class="row flex-column-reverse flex-lg-row">
                    ...
                    <div class="col-md-12 col-lg-10">
                        ...
                        <div class="swiper product-large-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="image-zoom" data-scale="2.5" data-image="/storage/{{$product->image}}"><img src="/storage/{{$product->image}}" alt="product-large" class="img-fluid"></div>
                                </div>
                                <!-- <div class="swiper-slide">
                                        <div class="image-zoom" data-scale="2.5" data-image="images/product-large-2.jpg"><img src="images/product-large-2.jpg" alt="product-large" class="img-fluid"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image-zoom" data-scale="2.5" data-image="images/product-large-3.jpg"><img src="images/product-large-3.jpg" alt="product-large" class="img-fluid"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image-zoom" data-scale="2.5" data-image="images/product-large-4.jpg"><img src="images/product-large-4.jpg" alt="product-large" class="img-fluid"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image-zoom" data-scale="2.5" data-image="images/product-large-5.jpg"><img src="images/product-large-5.jpg" alt="product-large" class="img-fluid"></div>
                                    </div> -->
                            </div>
            ...
            <div class="col-lg-5">
                <div class="product-info">
                    ...
                    <div class="cart-wrap py-5">
                        ...
                        <div class="product-quantity pt-3">
                            ...
                            <div class="stock-button-wrap">
                                ...
                                <form action="/product/{{$product->id}}/add-to-cart" type="POST">
                                    ...
                                    <div class="qty-button d-flex flex-wrap pt-3">
                                        ...
                                        <button type="submit" value="1269" class="btn btn-dark py-3 px-4 text-uppercase mt-3">Add to cart</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="meta-product py-2">
                        ...
                        <div class="meta-item d-flex align-items-baseline">
                            <h6 class="item-title no-margin pe-2">Brand:</h6>
                            <ul class="select-list list-unstyled d-flex">
                                <li data-value="S" class="select-item">
                                    <a href="/category/{{$product->brand->id}}">{{$product->brand->name}}</a>,
                                </li>
                            </ul>
                        </div>
                    </div>
