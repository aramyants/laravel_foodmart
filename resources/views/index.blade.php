        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="banner-blocks">
                                ...
                                <div class="swiper-slide">
                                    <div class="row banner-content p-5">
                                        <div class="content-wrapper col-md-7">
                                            <div class="categories my-3">{{ $banner->tag }}</div>
                                            <h3 class="display-4">{{ $banner->title }}</h3>
                                            <p>{{ $banner->description }}</p>
                                            <a href="{{ $banner->button_link }}" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 px-4 py-3 mt-3">{{ $banner->button_text }}</a>
                                        </div>
                                        <div class="img-wrapper col-md-5">
                                            <img src="storage/{{ $banner->image }}" alt="Product Thumbnail" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                    ...
                    <div class="banner-ad bg-success-subtle block-2" style="background:url('/images/product-thumb-2.png') no-repeat;background-position: right bottom">
                        <div class="row banner-content p-5">

                            <div class="content-wrapper col-md-7">
                                <div class="categories sale mb-3 pb-3">20% off</div>
                                <h3 class="banner-title">Fruits & Vegetables</h3>
                                <a href="/shop" class="d-flex align-items-center nav-link">Shop Collection <svg width="24" height="24">
                    ...
                    <div class="banner-ad bg-danger block-3" style="background:url('/images/thumb-cucumber.png') no-repeat;background-position: right bottom">
                        <div class="row banner-content p-5">
            ...
            <div class="col-md-12">
                ...
                <div class="section-header d-flex flex-wrap justify-content-between mb-5">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="/shop" class="btn-link text-decoration-none">View All Categories →</a>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="storage/{{$brand->logo}}" class="img-fluid rounded" alt="Card title">
                                    </div>
                                    <div class="col-md-8">
                                ...
                                <div class="col">
                                    <div class="product-item">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="#" class="nav-link">Add to Cart <svg width="18" height="18">
            ...
            <div class="col-md-6">
                <div class="banner-ad bg-danger mb-3" style="background: url('images/ad-image-3.png');background-repeat: no-repeat;background-position: right bottom;">
                    <div class="banner-content p-5">
                        ...
                        <a href="/shop" class="btn btn-dark text-uppercase">Show Now</a>
